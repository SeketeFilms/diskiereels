/**
 * Adds DiskieReels watermark and creator outro to a video using Canvas API
 */
    ...
    video.onloadedmetadata = () => {
      ...
      const drawFrame = () => {
        ...
        if (isOutro) {
          ...
          ctx.fillText('DiskieReels', canvas.width / 2, canvas.height - 60);
          ...
          ctx.shadowOffsetY = 2;
          ctx.textAlign = 'left';
          ctx.fillText('DiskieReels', 10, canvas.height - 10);
        }
