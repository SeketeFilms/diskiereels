        ...
        <div className="p-4 pb-8 max-w-2xl mx-auto">
          <div className="space-y-6 text-sm text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>
                Welcome to DiskieReels ("App", "Service", "we", "us", or "our"). By downloading, 
                installing, accessing, or using DiskieReels, you agree to be bound by these 
                Terms of Service ("Terms"). If you do not agree to these Terms, do not use 
                the App.
              </p>
              <p>
                DiskieReels is designed for children all ages ("Children") under parental supervision. 
            ...
            <section className="space-y-3">
              ...
              <p>
                DiskieReels participates in the Google Play "Designed for Families" program and 
            ...
            <section className="space-y-3">
              ...
              <p>
                To use certain features of DiskieReels, you must create an account. By creating 
                an account:
              </p>
              <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <section className="space-y-3">
              ...
              <p>
                DiskieReels allows verified creators to upload animated content. By uploading content:
              </p>
              <ul className="list-disc list-inside space-y-1 pl-2">
                <li>You confirm you own or have rights to the content</li>
                <li>Content must be appropriate for children all ages</li>
            ...
            <section className="space-y-3">
              ...
              <p>
                DiskieReels includes safety features for child protection:
              </p>
              <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <section className="space-y-3">
              ...
              <p>
                DiskieReels and its original content, features, and functionality are owned by 
            ...
            <section className="space-y-3">
              ...
              <p>
                DiskieReels is provided "AS IS" without warranties of any kind. We do not guarantee:
              </p>
              <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <section className="space-y-3">
              ...
              <p>
                To the maximum extent permitted by law, DiskieReels and SEMO Group shall not be 
